...
contract LinearRelease is Ownable, ReentrancyGuard {
  ...
  function calLockAmount(uint256 _amount) public onlyChefBami view returns (uint256) {
  ...
  function lock(address _user, uint256 _amount) public nonReentrant onlyChefBami {
